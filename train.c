...
void main()
{
    ...
    printf("\t\t2. Shatabdi Express...", ".......05:00 ", "p.m........Howrah Station\n");
...
void details(int k)
{
    ...
    for (i = 1; i <= k; i++)
    {
        printf("Enter The %d the Passenger Name: \n", i);
        fflush(stdin);
        gets(val);
        printf("Enter The %d th Passenger Gender: \n", i);
        fflush(stdin);
        gets(gen);
        printf("Enter The %d th Passenger Age:\n ", i);
        fflush(stdin);
        scanf("%d", &a);
